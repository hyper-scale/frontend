...
const Landing = () => (
	<div>
		...
		<head>
			...
			<script async src="https://www.googletagmanager.com/gtag/js?id=G-6Q4FQEBFKC"></script>
			<script>
			window.dataLayer = window.dataLayer || [];
			function gtag(){dataLayer.push(arguments);}
			gtag('js', new Date());

			gtag('config', 'G-6Q4FQEBFKC');
			</script>
		</head>
		<div
						...
						<div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
							<h1>
								<span className="mt-1 block text-gray-900 text-4xl tracking-tight font-extrabold sm:text-5xl xl:text-6xl">
									...
									<span className="underlined">early</span> web3 projects
								</span>
							</h1>
